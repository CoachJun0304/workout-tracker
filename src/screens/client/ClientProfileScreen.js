...
import {
  ...
  Modal, TextInput as RNTextInput, Platform
} from 'react-native';
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.unitCard}>
        ...
        <Text style={styles.unitHint}>All weights auto-convert across the app</Text>
      </View>
      ...
      <View style={styles.waterCard}>
        ...
        <View style={styles.waterBtns}>
          ...
          <TouchableOpacity
            style={[styles.waterBtn, { borderColor: COLORS.error }]}
        ...
        <View style={styles.waterProgress}>
          <View style={[styles.waterFill, {
            width: `${Math.min((waterToday / 2000) * 100, 100)}%`
          }]} />
        </View>
        <Text style={styles.waterGoal}>
          Goal: 2000ml / {Math.round((waterToday / 2000) * 100)}% reached
        </Text>
      </View>
      ...
      {editing ? (
        <View style={styles.editCard}>
          ...
          {[
            ...
            <View key={f.field}>
              ...
              <TextInput
                value={form[f.field]}
                onChangeText={v => update(f.field, v)}
                style={styles.input}
                mode="outlined"
                keyboardType={f.type}
        ...
        <View style={styles.infoCard}>
          ...
          <InfoRow label="Age" value={form.age ? `${form.age} yrs` : null} />
...
const styles = StyleSheet.create({
  ...
  sectionLabel: { color: COLORS.textSecondary, fontSize: SIZES.xs, ...FONTS.bold, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 10 },
  ...
  historyBtn: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.darkCard, borderRadius: RADIUS.lg, padding: 16, marginBottom: 12, borderWidth: 1, borderColor: COLORS.darkBorder },
  historyBtnIcon: { fontSize: 20, marginRight: 12 },
  historyBtnText: { flex: 1, color: COLORS.white, ...FONTS.semibold, fontSize: SIZES.md },
  historyBtnArrow: { color: COLORS.roseGold, fontSize: 20, ...FONTS.bold },
